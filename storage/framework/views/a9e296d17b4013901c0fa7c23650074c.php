...
<?php foreach($attributes->onlyProps(['child','afterLeave']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['child','afterLeave']); ?>
<?php foreach (array_filter((['child','afterLeave']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = ProtoneMedia\Splade\Components\Transition::resolve(['child' => $child,'afterLeave' => $afterLeave] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH D:\Work\Project\Learning\TrySplade\storage\framework\views/02aeb5933e1aa29c97dfbee1b4cd27b9.blade.php ENDPATH**/ ?>