...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Halaman Create Users')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'space-y-4','action' => ''.e(route('users.store')).'']); ?>
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\Learning\TrySplade\resources\views/users/create.blade.php ENDPATH**/ ?>