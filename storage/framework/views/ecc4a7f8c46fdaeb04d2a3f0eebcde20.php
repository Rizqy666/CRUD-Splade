...
<?php foreach($attributes->onlyProps(['child','animation']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['child','animation']); ?>
<?php foreach (array_filter((['child','animation']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = ProtoneMedia\Splade\Components\Transition::resolve(['child' => $child,'animation' => $animation] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH D:\Work\Project\Learning\TrySplade\storage\framework\views/70a054acfbbb7ba803410aa046309de2.blade.php ENDPATH**/ ?>