<nav role="navigation" aria-label="<?php echo e(__('Pagination Navigation')); ?>" class="flex items-center justify-between px-4 sm:px-0 py-3">
    <div class="flex justify-between flex-1 md:hidden">
        ...
        <?php else: ?>
            <a @click.exact.prevent="table.navigate(<?php echo \Illuminate\Support\Js::from($paginationUrl = $paginator->previousPageUrl())->toHtml() ?>, true)" dusk="pagination-simple-previous" href="<?php echo e($paginationUrl); ?>" class="relative inline-flex items-center px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                <?php echo __('pagination.previous'); ?>

            </a>
        <?php endif; ?>

        <?php echo $__env->renderWhen($hasPerPageOptions ?? true, 'splade::table.per-page-selector', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>

        <?php if($paginator->hasMorePages()): ?>
            <a @click.exact.prevent="table.navigate(<?php echo \Illuminate\Support\Js::from($paginationUrl = $paginator->nextPageUrl())->toHtml() ?>, true)" dusk="pagination-simple-next" href="<?php echo e($paginationUrl); ?>" class="relative inline-flex items-center px-4 py-2 ml-3 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
    ...
    <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
        <div class="flex items-center">
            ...
            <div class="hidden lg:block <?php if($hasPerPageOptions ?? true): ?> ml-3 <?php endif; ?>">
                ...
                <?php $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if(is_string($element)): ?>
                        <span aria-disabled="true">
                            <span class="relative inline-flex items-center px-4 py-2 -ml-px text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 cursor-default leading-5"><?php echo e($element); ?></span>
                        </span>
                    <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page == $paginator->currentPage()): ?>
                                <span aria-current="page">
                                    <span class="relative inline-flex items-center px-4 py-2 -ml-px text-xs sm:text-sm font-medium bg-indigo-50 border-indigo-500 text-indigo-600 z-10 border cursor-default leading-5"><?php echo e($page); ?></span>
                                </span>
                            <?php else: ?>
                                <a @click.exact.prevent="table.navigate(<?php echo \Illuminate\Support\Js::from($url)->toHtml() ?>, true)" dusk="pagination-<?php echo e($page); ?>" href="<?php echo e($url); ?>" class="relative inline-flex items-center px-4 py-2 -ml-px text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150" aria-label="<?php echo e(__('Go to page :page', ['page' => $page])); ?>">
                                    <?php echo e($page); ?>
...
</nav><?php /**PATH D:\Work\Project\Learning\TrySplade\vendor\protonemedia\laravel-splade\src/../resources/views/table/pagination.blade.php ENDPATH**/ ?>