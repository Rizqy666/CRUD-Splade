...
<SpladeButton <?php echo e($attributes->only(['v-bind:spinner', ':spinner'])); ?>>
    <template #default="button">
        <<?php echo e($type === 'link' ? 'Link' : 'button'); ?> :disabled="button.spinner" <?php echo e($attributes->class([
        ...
        >
            ...
            <?php endif; ?>
        </<?php echo e($type === 'link' ? 'Link' : 'button'); ?>>
    </template>
</SpladeButton><?php /**PATH D:\Work\Project\Learning\TrySplade\vendor\protonemedia\laravel-splade\src/../resources/views/components/button.blade.php ENDPATH**/ ?>