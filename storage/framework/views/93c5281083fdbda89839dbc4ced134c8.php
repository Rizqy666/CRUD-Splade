...
<?php foreach($attributes->onlyProps(['animation','appear','show']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['animation','appear','show']); ?>
<?php foreach (array_filter((['animation','appear','show']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = ProtoneMedia\Splade\Components\Transition::resolve(['animation' => $animation,'appear' => $appear,'show' => $show] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH D:\Work\Project\Learning\TrySplade\storage\framework\views/a4831aa28b752e0375fde8b0d092a685.blade.php ENDPATH**/ ?>