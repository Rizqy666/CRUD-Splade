...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('users.create')).'','class' => 'bg-blue-500 hover:bg-blue-600 focus:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105']); ?>
                        Insert User
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\Learning\TrySplade\resources\views/users/index.blade.php ENDPATH**/ ?>