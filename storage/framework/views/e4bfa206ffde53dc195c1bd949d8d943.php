...
<?php foreach($attributes->onlyProps(['show']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['show']); ?>
<?php foreach (array_filter((['show']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = ProtoneMedia\Splade\Components\Transition::resolve(['show' => $show] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH D:\Work\Project\Learning\TrySplade\storage\framework\views/605cfe81b5515d14720d310325598dd2.blade.php ENDPATH**/ ?>